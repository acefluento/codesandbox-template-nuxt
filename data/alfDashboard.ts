...
export const platformStats: PlatformStats[] = [
  { platform: 'google', displayName: 'Google', currentRating: 4.7, reviewCount: 51, accentColor: 'text-yellow-400' },
  { platform: 'yelp', displayName: 'Yelp', currentRating: 4.4, reviewCount: 17, accentColor: 'text-brand-red' },
  { platform: 'facebook', displayName: 'Facebook', currentRating: 4.8, reviewCount: 12, accentColor: 'text-blue-400' },
  {
...
export const reviewCampaigns: ReviewCampaign[] = [
  { id: 'c1', residentName: 'R. Thompson', status: 'reviewed', channel: 'sms', sentDate: '2024-01-10', platform: 'google' },
  { id: 'c2', residentName: 'M. Patterson', status: 'clicked', channel: 'email', sentDate: '2024-01-11', platform: 'yelp' },
  { id: 'c3', residentName: 'D. Whitfield', status: 'opened', channel: 'sms', sentDate: '2024-01-12', platform: 'google' },
  { id: 'c4', residentName: 'A. Nguyen', status: 'sent', channel: 'email', sentDate: '2024-01-13', platform: 'facebook' },
  { id: 'c5', residentName: 'L. Graham', status: 'reviewed', channel: 'sms', sentDate: '2024-01-05', platform: 'google' },
  { id: 'c6', residentName: 'C. Morrison', status: 'sent', channel: 'email', sentDate: '2024-01-14', platform: 'assistedlivingcenter' },
  { id: 'c7', residentName: 'E. Harrington', status: 'queued', channel: 'sms', sentDate: '2024-01-15', platform: 'google' },
  { id: 'c8', residentName: 'B. Crawford', status: 'queued', channel: 'email', sentDate: '2024-01-15', platform: 'yelp' },
]
