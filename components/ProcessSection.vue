    ...
    <div class="relative max-w-7xl mx-auto px-6">
      ...
      <div class="max-w-4xl mx-auto">
        <div class="relative">
          ...
          <div
            class="absolute left-8 top-8 bottom-8 w-px bg-gradient-to-b from-brand-blue/40 via-brand-blue/20 to-transparent hidden sm:block"
          ></div>
                ...
                <div
                  ...
                  :class="
                    step.number === '01'
                      ...
                      : 'border-white/15 bg-brand-navy-2'
                  "
                >
                  <span
                    class="text-lg font-black"
                    :class="
                      step.number === '01' ? 'text-brand-blue' : 'text-white/40'
                    "
                  >
                    {{ step.number }}
                  </span>
