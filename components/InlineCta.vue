<template>
  <div class="py-12 border-y border-white/[0.06]" :class="dark ? 'bg-brand-navy' : 'bg-brand-navy-2'">
    <div class="max-w-4xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
      <p class="text-white/65 text-base font-medium text-center sm:text-left">
        {{ message }}
      </p>
      <a
        href="#contact"
