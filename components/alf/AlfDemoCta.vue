<template>
  <section id="demo" class="py-28 relative overflow-hidden">
    ...
    <div class="absolute inset-0 pointer-events-none">
      ...
      ></div>
      <div
        class="absolute top-0 right-1/4 w-[400px] h-[300px] bg-emerald-500/3 rounded-full blur-3xl"
      ></div>
    </div>
    <div
      ...
      <div class="grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div v-reveal="'fade-left'">
          ...
          <p class="text-white/55 text-base mb-6 leading-relaxed max-w-md">
            We'll show you the dashboard live, walk through how we set up
            Magnolia Manor, and give you a reputation audit for your facility —
            no cost, no pressure.
          </p>
          ...
          >
            <div class="max-w-sm text-center">
              <p class="text-white/70 text-base mb-5">
                Load the scheduler when you're ready to book your demo.
              </p>
