...
export const alfCaseStudyMetrics: AlfCaseStudyMetric[] = [
  { label: 'Google Rating', before: '3.2★', after: '4.7★', accent: 'text-emerald-400' },
  { label: 'Response Rate', before: '0%', after: '100%', accent: 'text-brand-blue' },
  { label: 'Monthly Inquiries', before: '4', after: '11', accent: 'text-brand-blue' },
  { label: 'Move-ins Attributed', before: '0', after: '3', accent: 'text-emerald-400' },
]
...
export const alfFaqs: AlfFaq[] = [
  ...
  {
    question: 'We already have a Google Business account. Does that still work?',
    answer:
